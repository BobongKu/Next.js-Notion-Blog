...
export default function Header() {
    return (
        <nav class="blur-header">
            <div class="container m-auto px-2 md:px-12 lg:px-7">
                <div class="flex flex-wrap items-center justify-between py-2 gap-6 md:py-3 md:gap-0 relative">
                    ...
                    <div class="w-full px-6 flex justify-between lg:w-max md:px-0">
                        <Link href='/'>
                            <a aria-label="logo" class="flex space-x-2 items-center">
                                <span class="text-2xl font-bold text-gray-900 dark:text-white">Bobong</span>
                            </a>
                        </Link>
                    ...
                    lg:bg-transparent lg:w-7/12">
                        ...
                        <div class="border-t-2 border-dashed border-gray-600 dark:border-white w-full lg:w-max gap-3 pt-2 lg:pt-0 lg:pl-2 lg:border-t-0 lg:border-l-2 flex flex-col lg:gap-0 lg:flex-row items-center">
